...
watch(
    () => diagForm.disease_type_id,
    (value) => {
        diagForm.reset("disease_id", "procedure_id");
        filterDiseases.value = props.diseases?.filter(
            (disease: any) => disease.disease_type_id === value
        );
        filterProcedures.value = props.procedures?.filter(
            (procedure: any) => procedure.disease_type_id === value
        );
    }
);
...
watch(
    () => labForm.test_category_id,
    (value) => {
        labForm.reset("test_type_id");
        filterTestTypes.value = props.testTypes?.filter(
            (testType: any) => testType.test_category_id === value
        );
    }
);

watch(
    () => labForm.test_type_id,
    (value) => {
        labForm.reset("test_id");
        filterTests.value = props.tests?.filter(
            (test: any) => test.test_type_id === value
        );
    }
);

const getRiskFactorName = (id: number) =>
    (props.riskFactors?.find((riskFactor: any) => riskFactor.id === id) as any)
        ?.factor_name;
const getComplaintName = (id: number) =>
    (props.complaints?.find((complaint: any) => complaint.id === id) as any)
        ?.complaint_name;
const getDiseaseTypeName = (id: number) =>
    (
        props.diseaseTypes?.find(
            (diseaseType: any) => diseaseType.id === id
        ) as any
    )?.type_name;
const getDiseaseName = (id: number) =>
    (props.diseases.find((disease: any) => disease.id === id) as any)
        ?.disease_name;
const getProcedureName = (id: number) =>
    (props.procedures.find((procedure: any) => procedure.id === id) as any)
        ?.procedure_name || "Not Available";
...
const getHospitalName = (id: number) =>
    (props.hospitals?.find((hospital: any) => hospital.id === id) as any)
        ?.hospital_name;
const getTestCategoryName = (id: number) =>
    (props.testCategories?.find((category: any) => category.id === id) as any)
        ?.category_name;
const getTestTypeName = (id: number) =>
    (props.testTypes?.find((type: any) => type.id === id) as any)?.type_name;
const getTestName = (id: number) =>
    (props.tests?.find((test: any) => test.id === id) as any)?.test_name;
const getLabName = (id: number) =>
    (props.labs?.find((lab: any) => lab.id === id) as any)?.lab_name;
...
const deleteRiskFactor = (_obj: Object) =>
    (preForm.patient_risk_factors = preForm.patient_risk_factors.filter(
        (obj) => obj !== _obj
    ));
...
const deleteComplaint = (_obj: Object) =>
    (preForm.patient_complaints = preForm.patient_complaints.filter(
        (obj) => obj !== _obj
    ));
...
const deleteDisease = (_obj: Object) =>
    (preForm.patient_diseases = preForm.patient_diseases.filter(
        (obj) => obj !== _obj
    ));
...
const deleteDiagnosis = (dig: Object) =>
    (preForm.patient_diagnoses = preForm.patient_diagnoses.filter(
        (obj) => obj !== dig
    ));
...
const deleteHospital = (hospital: Object) =>
    (preForm.patient_hospitals = preForm.patient_hospitals.filter(
        (obj) => obj !== hospital
    ));
...
const addLab = () => {
    ...
    if (
        row.test_category_id === null ||
        row.test_type_id === null ||
        row.test_id === null ||
        row.lab_id === null
    )
        return;
...
<template>
    ...
    <form
        @submit.prevent="
            preForm.post(route('registrations.checkout', patientVisit?.id))
        "
    >
        <Toolbar
            title="Prescription"
                    ...
                    <div class="card-body card-custom">
                        ...
                        <div class="tab-content">
                            ...
                            >
                                ...
                                >
                                    <span class="text-uppercase">Vitals</span>
                                </h4>
                                <div class="section_box">
                                    ...
                                    <div class="mb-10 row">
                                        <div class="col-lg-4">
                                            ...
                                            >
                                            <v-select
                                                v-model="preForm.pulse"
                                                :options="range(50, 120, 1, 0)"
                                                class="v-select-custom"
                                                placeholder="Please Select"
                                            />
                                            <ServerErrorMessage
                                                :error="preForm.errors.pulse"
                                            />
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            >
                                            <input
                                                v-model="preForm.sugar"
                                                type="text"
                                                class="form-control form-control-sm"
                                                placeholder="Sugar (mg/dL)"
                                            />
                                            <ServerErrorMessage
                                                :error="preForm.errors.sugar"
                                            />
                                        </div>
                                        <div class="col-lg-4">
                                            <label class="form-label"
                                    ...
                                    <div class="mb-10 row">
                                        <div class="col-lg-12">
                                            ...
                                            >
                                            <textarea
                                                v-model="preForm.notes"
                                                class="form-control form-control-sm"
                                                rows="4"
                                            ></textarea>
                                            <ServerErrorMessage
                                                :error="preForm.errors.notes"
                                            />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="section_box">
                                    <div class="table-responsive">
                                        ...
                                        >
                                            ...
                                            <tbody>
                                                <template
                                                    v-for="history in patient?.patient_visits"
                                                    :key="history.id"
                                                >
                                                    <tr>
                                                        <td class="text-start">
                                ...
                                <div class="section_box">
                                    <div class="mb-10 row">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <textarea
                                                v-model="
                                                    riskFactorForm.risk_factor_notes
                                                "
                                                class="form-control form-control-sm"
                                                rows="2"
                                            ></textarea>
                                    ...
                                    <div class="mb-10 row">
                                        <div class="table-responsive">
                                            ...
                                            >
                                                ...
                                                <tbody>
                                                    <template
                                                        v-for="risk_factor in preForm.patient_risk_factors"
                                                    >
                                                        <tr>
                                                            <td
                                                                class="text-start"
                                ...
                                <div class="section_box">
                                    <div class="table-responsive">
                                        ...
                                        >
                                            ...
                                            <tbody>
                                                <template
                                                    v-for="history in patient?.patient_risk_factors"
                                                    :key="history.id"
                                                >
                                                    <tr>
                                                        <td class="text-start">
                            ...
                            >
                                    ...
                                    <div class="mb-10 row">
                                        <div class="table-responsive">
                                            ...
                                            >
                                                ...
                                                <tbody>
                                                    <template
                                                        v-for="complaint in preForm.patient_complaints"
                                                    >
                                                        <tr>
                                                            <td
                                                                class="text-start"
                                ...
                                <h4
                                    class="font-weight-bold main_section_heading mt-6"
                                >
                                    <span class="text-uppercase">Disease</span>
                                </h4>
                                <div class="section_box">
                                    <div class="mb-10 row">
                                        <div class="col-lg-4">
                                            ...
                                            >
                                            <v-select
                                                v-model="diseaseForm.disease_id"
                                                :options="diseases"
                                                label="disease_name"
                                                :reduce="(option) => option.id"
                                                class="v-select-custom"
                                    ...
                                    <div class="mb-10 row">
                                        <div class="table-responsive">
                                            ...
                                            >
                                                ...
                                                <tbody>
                                                    <template
                                                        v-for="disease in preForm.patient_diseases"
                                                    >
                                                        <tr>
                                                            <td
                                                                class="text-start"
                                ...
                                <div class="section_box">
                                    <div class="table-responsive">
                                        ...
                                        >
                                            ...
                                            <tbody>
                                                <template
                                                    v-for="history in patient?.patient_complaints"
                                                    :key="history.id"
                                                >
                                                    <tr>
                                                        <td class="text-start">
                                ...
                                <div class="section_box">
                                    <div class="table-responsive">
                                        ...
                                        >
                                            ...
                                            <tbody>
                                                <template
                                                    v-for="history in patient?.patient_diseases"
                                                    :key="history.id"
                                                >
                                                    <tr>
                                                        <td class="text-start">
                                    ...
                                    <div class="mb-10 row">
                                        <div class="table-responsive">
                                            ...
                                            >
                                                ...
                                                <tbody>
                                                    <template
                                                        v-for="dig in preForm.patient_diagnoses"
                                                    >
                                                        <tr>
                                                            <td
                                                                class="text-start"
                                ...
                                <div class="section_box">
                                    <div class="table-responsive">
                                        ...
                                        >
                                            ...
                                            <tbody>
                                                <template
                                                    v-for="history in patient?.patient_diagnoses"
                                                    :key="history.id"
                                                >
                                                    <tr>
                                                        <td class="text-start">
                                    ...
                                    <div class="row">
                                        <div class="table-responsive">
                                            ...
                                            >
                                                ...
                                                <tbody>
                                                    <template
                                                        v-for="pmed in preForm.patient_medicines"
                                                    >
                                                        <tr>
                                                            <td
                                                                class="text-start"
                                    ...
                                    <div class="row">
                                        <div class="table-responsive">
                                            ...
                                            >
                                                ...
                                                <tbody>
                                                    <template
                                                        v-for="pmed in preForm.patient_other_medicines"
                                                    >
                                                        <tr>
                                                            <td
                                                                class="text-start"
                                ...
                                <div class="section_box">
                                    <div class="table-responsive">
                                        ...
                                        >
                                            ...
                                            <tbody>
                                                <template
                                                    v-for="history in patient?.patient_medicines"
                                                    :key="history.id"
                                                >
                                                    <tr>
                                                        <td class="text-start">
                                                        ...
                                                        <td>
                                                            {{
                                                                history.duration_value
                                                            }}
                                                        </td>
                                                        <td>
                                                            {{
                                                                history.acquire_from
                                                            }}
                                                        </td>
                                                        <td>
                                                            {{
                                                                history.medicine_instructions
                                                            }}
                                                        </td>
                                                    </tr>
                                                </template>
                                ...
                                <div class="section_box">
                                    <div class="table-responsive">
                                        ...
                                        >
                                            ...
                                            <tbody>
                                                <template
                                                    v-for="history in patient?.patient_other_medicines"
                                                    :key="history.id"
                                                >
                                                    <tr>
                                                        <td class="text-start">
                            ...
                            >
                                    ...
                                    <div class="mb-10 row">
                                        <div class="table-responsive">
                                            ...
                                            >
                                                ...
                                                <tbody>
                                                    <template
                                                        v-for="lab in preForm.patient_labs"
                                                    >
                                                        <tr>
                                                            <td
                                                                class="text-start"
                                ...
                                <div class="section_box">
                                    <div class="mb-10 row">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            >
                                            <v-select
                                                v-model="hospitalForm.priority"
                                                :options="range(1, 50, 1, 0)"
                                                class="v-select-custom"
                                                placeholder="Please Select"
                                            />
                                            <ServerErrorMessage
                                                :error="
                                                    hospitalForm.errors.priority
                                                "
                                            />
                                        </div>
                                        <div class="col-lg-6">
                                            ...
                                            >
                                            <textarea
                                                v-model="hospitalForm.remarks"
                                                class="form-control form-control-sm"
                                                rows="2"
                                            ></textarea>
                                            <ServerErrorMessage
                                                :error="
                                                    hospitalForm.errors.remarks
                                                "
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-10 row">
                                        <div class="table-responsive">
                                            ...
                                            >
                                                ...
                                                <tbody>
                                                    <template
                                                        v-for="hospital in preForm.patient_hospitals"
                                                    >
                                                        <tr>
                                                            <td
                                                                class="text-start"
                                ...
                                <div class="section_box">
                                    <div class="table-responsive">
                                        ...
                                        >
                                            ...
                                            <tbody>
                                                <template
                                                    v-for="history in patient?.patient_labs"
                                                    :key="history.id"
                                                >
                                                    <tr>
                                                        <td class="text-start">
                                ...
                                >
                                    <span class="text-uppercase"
                                        >Referral – Hospital History</span
                                    >
                                </h4>
                                <div class="section_box">
                                    <div class="table-responsive">
                                        ...
                                        >
                                            ...
                                            <tbody>
                                                <template
                                                    v-for="history in patient?.patient_hospitals"
                                                    :key="history.id"
                                                >
                                                    <tr>
                                                        <td class="text-start">
