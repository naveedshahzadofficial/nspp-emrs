        ...
        <div id="kt_content_container" class="container-fluid">
            <div class="card card-custom">
                ...
                <div class="card-body">
                    ...
                    <h4 class="font-weight-bold main_section_heading">
                    ...
                    <h4 class="font-weight-bold main_section_heading">
                        <span class="text-uppercase">Risk Factors</span>
                    </h4>
                    <div class="section_box">
                        <div
                    ...
                    <h4 class="font-weight-bold main_section_heading">
                        <span class="text-uppercase">Diseases</span>
                    </h4>
                    <div class="section_box">
                        <div
                            class="table-responsive"
                    ...
                    <h4 class="font-weight-bold main_section_heading">
                        <span class="text-uppercase">Diagnosis</span>
                    </h4>
                    <div class="section_box">
                        <div
                            class="table-responsive"
                    ...
                    <h4 class="font-weight-bold main_section_heading">
                        <span class="text-uppercase">Medicine</span>
                    </h4>
                    <div class="section_box">
                        <div
                            class="table-responsive"
                    ...
                    <h4 class="font-weight-bold main_section_heading">
                        <span class="text-uppercase">Referral – Labs</span>
                    </h4>
                    <div class="section_box">
                        <div
                            class="table-responsive"
                                ...
                                <tbody>
                                    ...
                                    >
                                        <tr>
                                            ...
                                            <td>
                                                {{ history?.test?.test_name }}
                                            </td>
                                            <td>
                                                {{ history.test_instructions }}
                                            </td>
                                            <td>
                                                {{ history?.lab?.lab_name }}
                                            </td>
                                        </tr>
                                    </template>
                                </tbody>
                    ...
                    <h4 class="font-weight-bold main_section_heading">
                        <span class="text-uppercase">Referral – Hospitals</span>
                    </h4>
                    <div class="section_box">
                        <div
                            class="table-responsive"
