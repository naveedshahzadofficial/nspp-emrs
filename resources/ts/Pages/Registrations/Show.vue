                    ...
                    <div class="section_box">
                        ...
                        >
                            ...
                            >
                                ...
                                <tbody>
                                    <template
                                        v-for="history in patientVisit?.patient_risk_factors"
                                        :key="history.id"
                                    >
                                        <tr>
                                            <td class="text-start">
                    ...
                    <div class="section_box">
                        ...
                        >
                            ...
                            >
                                ...
                                <tbody>
                                    <template
                                        v-for="history in patientVisit?.patient_complaints"
                                        :key="history.id"
                                    >
                                        <tr>
                                            <td class="text-start">
                    ...
                    <div class="section_box">
                        ...
                        >
                            ...
                            >
                                ...
                                <tbody>
                                    <template
                                        v-for="history in patientVisit?.patient_diseases"
                                        :key="history.id"
                                    >
                                        <tr>
                                            <td class="text-start">
                    ...
                    <div class="section_box">
                        ...
                        >
                            ...
                            >
                                ...
                                <tbody>
                                    <template
                                        v-for="history in patientVisit?.patient_diagnoses"
                                        :key="history.id"
                                    >
                                        <tr>
                                            <td class="text-start">
                    ...
                    <div class="section_box">
                        ...
                        >
                            ...
                            >
                                ...
                                <tbody>
                                    <template
                                        v-for="history in patientVisit?.patient_medicines"
                                        :key="history.id"
                                    >
                                        <tr>
                                            <td class="text-start">
                    ...
                    <div class="section_box">
                        ...
                        >
                            ...
                            >
                                ...
                                <tbody>
                                    <template
                                        v-for="history in patientVisit?.patient_other_medicines"
                                        :key="history.id"
                                    >
                                        <tr>
                                            <td class="text-start">
                    ...
                    <div class="section_box">
                        ...
                        >
                            ...
                            >
                                ...
                                <tbody>
                                    <template
                                        v-for="history in patientVisit?.patient_labs"
                                        :key="history.id"
                                    >
                                        <tr>
                                            <td class="text-start">
                    ...
                    <div class="section_box">
                        ...
                        >
                            ...
                            >
                                ...
                                <tbody>
                                    <template
                                        v-for="history in patientVisit?.patient_hospitals"
                                        :key="history.id"
                                    >
                                        <tr>
                                            <td class="text-start">
