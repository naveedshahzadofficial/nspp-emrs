...
const props = defineProps({
    testTypes: { type: Object, required: true },
    filters: Object,
});
...
<template>
    ...
    <Toolbar
        ...
        :buttons="[
            {
                label: 'Add Test Type',
                link: route('test-types.create'),
                permission: 'create test types',
            },
        ]"
        :breadcrumbs="[
            { label: 'System Settings', link: '#' },
            { label: 'Test Types', link: null },
        ]"
    />
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        >
                            ...
                            <tbody>
                                <template
                                    v-for="testType in testTypes.data"
                                    :key="testType.id"
                                >
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            {{ testType?.test_category?.category_name }}
                                        </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a
                                                v-if="
                                                    hasPermission(
                                                        'toggle status test types'
                                                    )
                                                "
                                                @click.prevent="
                                                    toggleStatus(
                                                        'test-types.toggle-status',
                                                        testType
                                                    )
                                                "
