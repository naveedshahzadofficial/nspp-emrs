...
const props = defineProps({
    ...
    testType: { type: Object, required: true },
});
const form = useForm({
    test_category_id: props.testType?.test_category_id,
    type_name: props.testType?.type_name,
    status: props.testType?.status,
});
</script>
