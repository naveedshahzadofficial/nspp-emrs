        ...
        :buttons="[
            {
                ...
                link: route('medicine-categories.create'),
                permission: 'create medicine categories',
            },
        ]"
        :breadcrumbs="[
            { label: 'System Settings', link: '#' },
            { label: 'Medicine Categories', link: null },
        ]"
    />
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        >
                            ...
                            <tbody>
                                <template
                                    v-for="medicineCategory in medicineCategories.data"
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a
                                                v-if="
                                                    hasPermission(
                                                        'toggle status medicine categories'
                                                    )
                                                "
                                                @click.prevent="
                                                    toggleStatus(
                                                        'medicine-categories.toggle-status',
                                                        medicineCategory
                                                    )
                                                "
                    ...
                    <Pagination
                        :meta="medicineCategories?.meta"
                        :links="medicineCategories?.links"
                    />
                </div>
            </div>
        </div>
