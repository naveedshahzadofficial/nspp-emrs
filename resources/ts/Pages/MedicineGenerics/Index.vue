                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        >
                            ...
                            <tbody>
                                <template
                                    v-for="medicineGeneric in medicineGenerics.data"
                                    :key="medicineGeneric.id"
                                >
                                    <tr>
                                        <td>
                                            {{ medicineGeneric.generic_name }}
                                        </td>
                                        <td class="text-center">
                                            <span
                                                class="badge font-weight-bold"
                                                :class="[
                                                    medicineGeneric.status
                                                        ? 'badge-success'
                                                        : 'badge-danger',
                                                ]"
                                            >
                                        ...
                                        <td class="text-center">
                                            <Link
                                                v-if="
                                                    hasPermission(
                                                        'view medicine generics'
                                                    )
                                                "
                                                :href="
                                                    route(
                                                        'medicine-generics.show',
                                                        medicineGeneric.id
                                                    )
                                                "
                                            ...
                                            <Link
                                                v-if="
                                                    hasPermission(
                                                        'update medicine generics'
                                                    )
                                                "
                                                :href="
                                                    route(
                                                        'medicine-generics.edit',
                                                        medicineGeneric.id
                                                    )
                                                "
                                            ...
                                            <a
                                                v-if="
                                                    hasPermission(
                                                        'toggle status medicine generics'
                                                    )
                                                "
                                                @click.prevent="
                                                    toggleStatus(
                                                        'medicine-generics.toggle-status',
                                                        medicineGeneric
                                                    )
                                                "
                                            ...
                                            <a
                                                v-if="
                                                    hasPermission(
                                                        'delete medicine generics'
                                                    )
                                                "
                                                @click.prevent="
                                                    destroy(
                                                        'medicine-generics.destroy',
                                                        medicineGeneric.id
                                                    )
                                                "
                    ...
                    <Pagination
                        :meta="medicineGenerics?.meta"
                        :links="medicineGenerics?.links"
                    />
                </div>
            </div>
        </div>
