...
const form = useForm({
    ...
    speciality: props.hospital?.speciality,
    address: props.hospital?.address,
    contact: props.hospital?.contact,
...
<template>
    ...
    <Toolbar
        title="Update Lab"
        :buttons="[{ label: 'Back', link: route('hospitals.index') }]"
        :breadcrumbs="[
            { label: 'System Settings', link: '#' },
            { label: 'Labs', link: route('hospitals.index') },
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div id="kt_content_container" class="container-fluid">
            <div class="card card-custom">
                ...
                <form
                    @submit.prevent="
                        form.put(route('hospitals.update', hospital?.id))
                    "
                >
                    <!--begin::Card body-->
                    <div class="card-body">
                        <div class="row mb-10">
                            <div class="col-lg-6">
                                ...
                                />
                                <ServerErrorMessage
                                    :error="form.errors.hospital_name"
                                />
                            </div>
                            <div class="col-lg-6">
                                <label class="required form-label"
