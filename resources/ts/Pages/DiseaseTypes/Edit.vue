<template>
    <Head title="Update Disease Type"/>
    <Toolbar
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div id="kt_content_container" class="container-fluid">
            <div class="card card-custom">
                <!--begin::Form-->
                <form @submit.prevent="form.put(route('disease-types.update', diseaseType?.id))">
                    <!--begin::Card body-->
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6">
...
const form = useForm({
    type_name: props.diseaseType?.type_name,
    status: props.diseaseType?.status,
});
</script>
