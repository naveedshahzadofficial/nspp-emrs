    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div id="kt_content_container" class="container-fluid">
            <div class="card card-custom">
                <!--begin::Form-->
                <form @submit.prevent="form.put(route('patients.update', patient?.id))">
...
const form = useForm({
    patient_type_id: props.patient?.patient_type_id,
    patient_name: props.patient?.patient_name,
    gender_id: props.patient?.gender_id,
    patient_age: props.patient?.patient_age,
    relationship_with_employee: props.patient?.relationship_with_employee,
    designation: props.patient?.designation,
    patient_cnic: props.patient?.patient_cnic,
