...
function usePermission() {
  ...
  var hasPermission = function hasPermission(name) {
    ...
    return (_usePage$props$auth2 = (0,_inertiajs_vue3__WEBPACK_IMPORTED_MODULE_0__.usePage)().props.auth) === null || _usePage$props$auth2 === void 0 ? void 0 : (_usePage$props$auth2$ = _usePage$props$auth2.user) === null || _usePage$props$auth2$ === void 0 ? void 0 : _usePage$props$auth2$.permissions.includes(name);
  };
  return {
    hasRole: hasRole,
    hasPermission: hasPermission
