...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  setup: function setup(__props, _ref) {
    var _props$medicine, _props$medicine2;
    var __expose = _ref.expose;
    __expose();
    var props = __props;
    var form = (0,_inertiajs_vue3__WEBPACK_IMPORTED_MODULE_2__.useForm)({
      medicine_name: (_props$medicine = props.medicine) === null || _props$medicine === void 0 ? void 0 : _props$medicine.medicine_name,
      status: (_props$medicine2 = props.medicine) === null || _props$medicine2 === void 0 ? void 0 : _props$medicine2.status
    });
    var __returned__ = {
      props: props,
      form: form,
