...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        $permissions = [
            ...
            'list test categories', 'create test categories', 'view test categories', 'update test categories', 'delete test categories', 'restore test categories', 'force delete test categories', 'toggle status test categories',
            'list test types', 'create test types', 'view test types', 'update test types', 'delete test types', 'restore test types', 'force delete test types', 'toggle status test types',
            'list tests', 'create tests', 'view tests', 'update tests', 'delete tests', 'restore tests', 'force delete tests', 'toggle status tests',
