...
class MedicineResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'status' => $this->status,
            'total_stocks' => $this->total_stocks??0,
            'consume_medicine_stocks' => $this->consume_medicine_stocks??0,
            'consume_other_medicine_stocks' => $this->consume_other_medicine_stocks??0,
            'total_stocks_qty' => (($this->total_stocks??0) - (($this->consume_medicine_stocks??0) + ($this->consume_other_medicine_stocks??0))),
